...
source=(https://mirrors.edge.kernel.org/pub/linux/utils/boot/dracut/dracut-${pkgver}.tar{.gz,.sign}
        ...
        dracut-install-support-ZSTD-compressed-firmware.patch)
sha512sums=('3a5b82976bfff9d71ca305b786fd9218849d28e0ef36356b19e558e50fefcca540dc15e6d93a15c7a8ade58d51dc32db8e4b0af924b5a9d85fa56a223501a9b6'
            ...
            'd63bf8a2bb4b370c98198cf8db37edb9723f82e6ca7ab89b25b7e93eff6654d1e0403c8a135018b815652e6b341de2ea925c3e917ef7b863d8d58a8702f93aa1')
validpgpkeys=(
...
prepare() {
  ...
  patch -Np1 < ../dracut-install-support-ZSTD-compressed-firmware.patch
}
